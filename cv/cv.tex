...
\textbf{Dissertation:} ``Rank-based Molecular Prognosis and Network-guided Biomarker Discovery for Breast Cancer''
...
\item Language: Chinese (native), English (proficient with certified CEFR level C2), French (conversational)
\end{itemize}
