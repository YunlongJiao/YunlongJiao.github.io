...
\hfill
Jan 2019 -- Feb 2019 & Teaching assistant of master course ``\href{http://members.cbio.mines-paristech.fr/~jvert/svn/kernelcourse/course/2019ammi/index.html}{Kernel Methods in Machine Learning}'' at \href{https://aimsammi.org/}{African Master's in Machine Intelligence (AMMI)}, \href{https://www.nexteinstein.org/}{African Institute for Mathematical Sciences (AIMS)}, Kigali, Rwanda, with Prof. \href{http://cbio.ensmp.fr/~jvert/}{Jean-Philippe Vert}\\\\
...
\begin{itemize}
\item Programming skills: Python, R, C/C++, Bash
\item Languages: Chinese (native), English (fully proficient with IELTS/CEFR level C2), French (conversational), Spanish (learning)
\end{itemize}
...
\item \hangbibentry{Jiao2018Kendall}
